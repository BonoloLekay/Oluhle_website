...
def booking_request():
    ...
    if request.method == "POST":
        ...
        if check_out_date <= check_in_date:
            ...
            return redirect(
                url_for("booking.booking_request")
            )
        ...
        resort_email = Message(
            subject="New Booking Request - Oluhle Resort",

            # COMPANY RECEIVES THE BOOKING
            recipients=[
                "oluhleresort@gmail.com"
            ],

            # EMAIL IS SENT FROM COMPANY EMAIL
...
"""
        ...
        try:
            ...
            print(
                "Resort email sent successfully."
            )

        except Exception as e:

            print(
                "Error sending resort email:",
                e
            )
